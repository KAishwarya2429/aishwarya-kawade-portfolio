export const resume = {
  ...
  timeline: [
    {
      year: "2019-2020",
      title: "SSC (10th Standard) – 87%",
      events: [
        "Completed Secondary School Certificate (SSC) with 87%",
        "Studied Mathematics, Science, Social Science, and English",
        "Built strong analytical and problem-solving foundations",
        "Developed an early interest in technology and computers",
      ],
    },
    {
      year: "2020-2022",
      title: "HSC (Science) – 68.69%",
      events: [
        "Completed Higher Secondary Certificate (HSC) in Science with 68.69%",
        "Studied Mathematics, Physics, Chemistry, and Biology",
        "Strengthened analytical thinking, logical reasoning, and quantitative skills",
        "Developed interest in Computer Science and programming fundamentals",
      ],
    },
    {
      year: "2023-2026",
      title: "Bachelor of Science in Computer Science – CGPA: 8.0",
      events: [
        "Graduated with a CGPA of 8.0 and a strong foundation in Computer Science",
        "Studied Data Structures, Algorithms, Databases, Operating Systems, Computer Networks, and Software Engineering",
        "Built full-stack, backend, and AI-powered applications using Java, Python, PostgreSQL, and modern web technologies",
        "Developed EarthAI, an AI-driven environmental monitoring platform as a major academic project",
        "Participated in hackathons, technical competitions, and collaborative software development programs",
        "Contributed to open-source projects through GirlScript Summer of Code (GSSoC)",
      ],
    },
    {
      year: "2026 - Present",
      ...
      events: [
        ...
        "Expanding expertise in Generative AI, Agentic AI, RAG, and System Design",
      ],
    },
    {
      year: "2026-Future",
      ...
      events: [
        "Contributing to open-source software and AI communities",
        "Building scalable AI, Backend, and Distributed Systems",
        "Exploring Generative AI, Agentic AI, and Large Language Models",
        "Working toward advanced research in Artificial Intelligence",
        "Aspiring to pursue PhD studies and contribute to global technology innovation",
      ],
    },
  ],
